...
@section('content')
    <div class="card p-4 shadow-sm">
        <h4 class="mb-4">পেজ এডিট করুন: {{ $page->title }}</h4>
        ...
        <form action="{{ route('admin.pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="content" class="summernote form-control">{{ old('content', $page->content) }}</textarea>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <textarea name="content_en" class="summernote form-control">{{ old('content_en', $page->content_en) }}</textarea>
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label font-weight-bold">Bangla Content (Right Column)</label>
                    <textarea name="content_bn" class="summernote form-control">{{ old('content_bn', $page->content_bn) }}</textarea>
                </div>
            </div>
            ...
            <div class="row bg-light p-3 rounded mb-3">
                <div class="col-md-6 mb-3">
                    ...
                    @if ($page->print_rate_card)
                        <small class="text-success d-block mt-1">ফাইল আপলোড করা আছে: <a
                                href="{{ asset('storage/' . $page->print_rate_card) }}" target="_blank">দেখুন</a></small>
                    @endif
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if ($page->digital_media_kit)
                        <small class="text-success d-block mt-1">ফাইল আপলোড করা আছে: <a
                                href="{{ asset('storage/' . $page->digital_media_kit) }}" target="_blank">দেখুন</a></small>
                    @endif
                </div>
            </div>
