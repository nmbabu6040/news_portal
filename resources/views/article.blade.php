...
@section('meta_image', $article->thumbnail ? asset('storage/' . $article->thumbnail) : '')
...
@section('content')
    <div class="row">
        <div class="col-lg-8">
            ...
            @if ($article->thumbnail_url && $article->type === 'article')
                <div class="mb-3">
                    <img src="{{ $article->thumbnail_url }}" class="img-fluid rounded mb-3" alt="{{ $article->title }}"
                ...
                <div class="row mt-3">
                    @foreach ($article->photos as $photo)
                        <div class="col-md-4 mb-3">
                            <img src="{{ asset('storage/' . $photo->image_path) }} → {{ $photo->image_url }}"
            ...
            <form action="{{ route('comment.store', $article) }}" method="POST">
                ...
                <div class="row g-2 mb-2">
                    ...
                    <div class="col-md-6"><input type="email" name="email" class="form-control" placeholder="ইমেইল"
                            required></div>
                </div>
